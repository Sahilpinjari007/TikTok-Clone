  ...
  return (
    <div className="w-full h-full">
      <div className="flex flex-col items-center justify-center text-center mx-auto">
        ...
        <p className="text-[24px] leading-[30px] font-bold mt-[24px] text-second-primary-text dark:text-dark-second-primary-text">No liked videos yet</p>
        <p className="text-[16px] leading-[21px] font-[400] mt-[8px] text-fifth-primary-text dark:text-dark-fifth-primary-text">Videos you liked will appear here</p>
      </div>
    </div>
  );
}
